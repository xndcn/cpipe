...
We're in **Phase 0** (`v0.1`). The local implementation is green; the remaining gates are GitHub Actions on `main`, the 24-hour green window, and the `v0.1` tag/release. See [`docs/phase-00-foundation.md`](docs/phase-00-foundation.md).
...
|--------|-------|-------------------------------------------------------------|-------------|
| `v0.1` | P0    | Foundation — repo skeleton, CI, plugin ABI, passthrough node | local green; CI/tag pending |
