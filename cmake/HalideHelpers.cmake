...
function(cpipe_add_halide_library target)
    ...
    foreach(arg IN LISTS ARGN)
        if(arg STREQUAL "host-vulkan")
            list(APPEND normalized_args "${Halide_HOST_TARGET}-vulkan")
        else()
            list(APPEND normalized_args "${arg}")
        endif()
    endforeach()
    add_halide_library(${target} ${normalized_args})
endfunction()
