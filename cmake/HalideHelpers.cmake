...
function(cpipe_halide_targets out_var)
    set(targets host)
    if(CPIPE_ENABLE_HALIDE_VULKAN)
        list(APPEND targets host-vulkan)
    endif()
...
function(cpipe_add_halide_runtime target)
    ...
    cpipe_halide_targets(runtime_targets)
    add_halide_runtime("${target}" TARGETS ${runtime_targets})
endfunction()
...
function(cpipe_add_halide_library target)
    ...
    if(NOT ARG_TARGETS)
        cpipe_halide_targets(ARG_TARGETS)
    endif()
