...
**Status.** In progress; detailed plan in [`phase-03-editor-iqa.md`](phase-03-editor-iqa.md). 7 sub-phases, 24 T-tasks (T0–T23); 50 `P3-PD-N` rows locked. P3 retires the carried [P2-PD-74](phase-02-classic-nodes-hdr.md#4-phase-decisions-p2-pd-n) (OCIO Vulkan execution) and adds RawTherapee 5.10 tooling for the algorithm-matched subset of [P1-PD-69 / P1-PD-70](phase-01-walking-skeleton.md#4-phase-decisions-pd-n) + [P2-PD-61 / P2-PD-62 / P2-PD-66 / P2-PD-67](phase-02-classic-nodes-hdr.md#4-phase-decisions-p2-pd-n); checked-in RT-derived replacements remain carried by [P3-PD-55](phase-03-editor-iqa.md#4-phase-decisions-p3-pd-n). Real Pixel / alt-phone QBC corpus, direct Halide Vulkan AOT command-buffer handoff, and binary Tracy capture stay carried to v1.1 per [P3-PD-46](phase-03-editor-iqa.md#4-phase-decisions-p3-pd-n).
...
- **Retired carry items** (relative to v0.3): OCIO Vulkan execution path ([P3-PD-44](phase-03-editor-iqa.md#4-phase-decisions-p3-pd-n) → glslang via vcpkg + `OcioVulkanProcessor::compute_pass`). RT 5.10 wrapper tooling lands in P3 T2, but checked-in RT-derived golden replacement remains carried by [P3-PD-55](phase-03-editor-iqa.md#4-phase-decisions-p3-pd-n).
