...
[[nodiscard]] constexpr auto operator|(BufferUsage lhs, BufferUsage rhs) noexcept -> BufferUsage {
...
[[nodiscard]] constexpr auto has_usage(BufferUsage usage, BufferUsage flag) noexcept -> bool {
