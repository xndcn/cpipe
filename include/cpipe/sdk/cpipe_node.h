...
// C99 ABI boundary; keep C typedefs, macros, and fixed C arrays.
// NOLINTBEGIN(cppcoreguidelines-avoid-c-arrays,cppcoreguidelines-macro-to-enum,cppcoreguidelines-macro-usage,modernize-avoid-c-arrays,modernize-deprecated-headers,modernize-macro-to-enum,modernize-use-using,performance-enum-size)
...
typedef struct {
    ...
    int (*get_format)(const cpipe_buffer_t*, int*);
    int (*get_kind)(const cpipe_buffer_t*, int*);
    int (*get_stride)(const cpipe_buffer_t*, uint64_t out_stride[8]);
    int (*get_color_role)(const cpipe_buffer_t*, const char**);
...
// NOLINTEND(cppcoreguidelines-avoid-c-arrays,cppcoreguidelines-macro-to-enum,cppcoreguidelines-macro-usage,modernize-avoid-c-arrays,modernize-deprecated-headers,modernize-macro-to-enum,modernize-use-using,performance-enum-size)
