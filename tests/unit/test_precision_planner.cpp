...
TEST_CASE("Pipeline load includes implicit precision_convert node") {
    ...
    std::string error;
    REQUIRE(cpipe::runtime::Pipeline::load(fixture_path("precision_auto_insert-v0.4.json"),
...
TEST_CASE("Pipeline rejects user-authored precision_convert nodes") {
    ...
    cpipe::runtime::Pipeline pipeline;
    std::string error;
    REQUIRE(cpipe::runtime::Pipeline::load(fixture_path("precision_convert_user-v0.4.json"),
