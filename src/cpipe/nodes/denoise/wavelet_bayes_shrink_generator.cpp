...
Halide::Expr soft_threshold(const Halide::Expr& value, float threshold) {
...
Halide::Expr block_value(const Halide::Func& chroma, const Halide::Expr& x, const Halide::Expr& y,
    ...
    const Halide::Expr h = soft_threshold(0.25F * (p00 - p10 + p01 - p11), 0.035F);
    const Halide::Expr v = soft_threshold(0.25F * (p00 + p10 - p01 - p11), 0.035F);
    const Halide::Expr d = soft_threshold(0.25F * (p00 - p10 - p01 + p11), 0.035F);
...
public:
    ...
    void generate() {
        ...
        const Halide::Expr denoised_co = block_value(co, x, y, ox, oy);
        const Halide::Expr denoised_cg = block_value(cg, x, y, ox, oy);
